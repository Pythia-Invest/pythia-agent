...
| `public_http.Transport` | In-process bounded HTTPS GET for keyless public APIs: fixed origins, no redirects, size/deadline bounds, budget permits and the same failure vocabulary as workers |
