...
async function mcpPost(fetcher, url, message, sessionId, options = {}) {
  const headers = {
...
function assertMcpProject(paths, result) {
...
function assertTextSearch(result) {
...
function assertMcpDiagnostics(paths, result) {
...
async function initializeMcp(paths, child, fetcher, timeout) {
