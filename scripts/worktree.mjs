...
const WORKTREE_BASE_ENV = "PYTHIA_AGENT_WORKTREE_BASE";
...
function resolveManagedWorktreePath(branch) {
...
function assertPythiaRepo(repoRoot) {
  ...
  try {
    ...
    if (err instanceof SyntaxError) {
      die(`could not parse '${packageJsonPath}': ${err.message}`);
    }
    throw err;
  }
}
