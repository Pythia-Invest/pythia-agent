...
ACTIONS = ["describe", "call", "search", "search_catalogue", "adopt_search", "details", "resolve_save", "series", "read", "read_many",
...
SCHEMA = {
    "name": TOOL_NAME,
    "description": (
        "Search investments across connected sources with search_catalogue; inspect sources, resolve references and read prices/history by canonical subject. "
