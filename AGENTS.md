...
| Financial widget presentation | [Market widget rule](.agents/rules/market-widgets.md) |
| Widget SDK, plugin widget contributions or widget hosting | [Widget authoring rule](.agents/rules/widget-authoring.md) |
